    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('customers.update', $customer->id) }}" method="POST">
                ...
                <input class="input is-rounded" type="text" name="name" value="{{ $customer->name }}">
                <label for="">Email address</label>
                <input class="input is-rounded" type="text" name="email" value="{{ $customer->email }}">
                <label for="">Birthday</label>
                <input class="input is-rounded" type="date" name="dob" value="{{ $customer->dob }}">
